...
**Codunot — your chat bot sidekick that can switch personalities and do more than just chat.** ***Made by a 13 year old with a little help from ChatGPT (code was written by a 13-year-old, comments, polishing, etc. were done by ChatGPT***
...
- **Generation / Analysis:** `/generate_image`, `/generate_video`, `/generate_tts`, `/transcribe`, `/guessage` *(analyzes up to 60 recent messages in-channel)*
...
*For casual Codunot enjoyers*  
• **50 messages / day**  
• **7 attachments / day**  
• **30 attachments per 2 months** *(rolling window)*
...
• **100 messages / day**  
• **10 attachments / day**  
• **50 attachments per 2 months** *(rolling window)*

🟡 **Gold 👑**

*Absolute Codunot god mode*  
• **Unlimited messages**  
• **15 attachments / day**  
• **100 attachments per 2 months** *(rolling window)*
...
• 2-month limits use a rolling window *(not calendar months)*  
• Older attachments automatically expire from the count
