...
PERSONAS = {
    ...
    "serious": (
        ...
        "If the user asks what all you can do, you can generate images, see and understand images, read files, "
...
async def decide_visual_type(user_text: str, chan_id: str) -> str:
    ...
    prompt = (
        ...
        "- If the user requests any type of content containing sex, NSFW content, kissing scenes, images of private parts, sexualized images of people, or content inappropriate for minors, return TEXT.\n"
		"- Examples -"
