...
async def boost_image_prompt(user_prompt: str) -> str:
    ...
    boost_instruction = (
		...
		"6. Whenever the user says anything like 'generate an image of a girl', or whenever it's obvious they want an image of a girl, the girl mustn't be very young, like 5-15 years. She must be around 20-25. This rule must be applied UNLESS the user specifies the age."
